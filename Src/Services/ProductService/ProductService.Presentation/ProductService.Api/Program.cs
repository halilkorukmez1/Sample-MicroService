...
builder.Services.Configure<ElasticSearchSetting>(builder.Configuration.GetSection("ElasticSearchConfig"));
var app = builder.Build();
IEventBus eventBus = app.Services.GetRequiredService<IEventBus>();
eventBus.Subscribe<WriteOutboxToElasticEvent, WriteOutboxToElasticEventHandler>();
